...
class GimoSubSeqDiscreteDataset(Dataset):
    '''
    ...
    def __init__(self, split='train', 
        ...
        '''
        super(GimoSubSeqDiscreteDataset, self).__init__()
    ...
    def __getitem__(self, idx):
        ...
        world2aligned_rot = data["world2aligned_rot"][1:-1]
        betas = data["betas"][1:-1]
        trans = data["trans"][1:-1]
        root_orient = data["root_orient"][1:-1]
        pose_body = data["pose_body"][1:-1]

        joints = data["joints"][1:-1]
        mojo_verts = data["mojo_verts"][1:-1]
        contacts = data["contacts"][1:-1]

        # joint_seq = joint_seq[1:-1]
        # if SAVE_MOJO_VERTS:
        world2aligned_rot = world2aligned_rot[sample_frame_inds]
        betas = betas[sample_frame_inds]
        trans = trans[sample_frame_inds]
        root_orient = root_orient[sample_frame_inds]
        pose_body = pose_body[sample_frame_inds]
        ...
        # Joints
        joints = joints[sample_frame_inds]
        verts = mojo_verts[sample_frame_inds]
